package com.mike.jaxrs.attachments.client;
...
public class FileClient {
	...
	private static final String FILE_PATH = "/Users/michaeljcastro/Desktop/tibu2.jpg";
	
	public static void main(String[] args) throws FileNotFoundException {
		WebClient client = WebClient.create("http://localhost:8080/restattachments/services/fileService/upload");
		client.type("multipart/form-data");
		ContentDisposition cd = new ContentDisposition("attachment;filename=tibu2.jpg");
